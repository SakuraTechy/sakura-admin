...
/**
 * Clear scene execution result request.
 */
@Data
@Schema(description = "Clear scene execution result request")
public class AutomationUiSceneClearReq implements Serializable {
