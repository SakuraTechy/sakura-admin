...
public class JobApi {
    ...
    public void getJob(){
        try {
            ...
            // 获取 Job 最后一个 build 编号
            System.out.println(job.getLastBuild().getNumber());
            // 获取 Job 下一个 build 编号
    ...
    public void getMavenJob(){
        try {
            // 获取 Job 信息
            MavenJobWithDetails job = jenkinsServer.getMavenJob("Sakura.Web.UI.Automation.Test");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void getJobConfig(){
        try {
            String xml = jenkinsServer.getJobXml("Sakura.Web.UI.Automation.Test");
    ...
    public void stopLastJobBuild(){
        try {
            // 获取最后的 build 信息
            Build build = jenkinsServer.getJob("Sakura.Web.UI.Automation.Test").getLastBuild();
            // 停止最后的 build
            build.Stop();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void deleteJob(){
        try {
            jenkinsServer.deleteJob("Sakura.Web.UI.Automation.Test");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void disableJob(){
        try {
            jenkinsServer.disableJob("Sakura.Web.UI.Automation.Test");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
