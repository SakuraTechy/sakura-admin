...
class TestPlanExecutionDispatchServiceTest {
    ...
    private final TestPlanExecutionDispatchService service = new TestPlanExecutionDispatchService(sceneMapper, executionRecordService, caseService, runnerJobService, reportProgressService, testPlanMapper);
